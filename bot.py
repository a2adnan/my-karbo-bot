...
AUTO_REPLIES = {
    ...
    "اكرهك": " بـس انـي اححـبـك😻😹✋🏿🍃", "ميو": " ااح كـطـوتي تماوي ❤️", "الكرادة": " احسن ناس وربي❤️",
    ...
    "اخوي": "دود وخنافس سود كون بطنك ياعفن يجايف ياعر اخوتك 😹✋🏿", "ضوجه": "☹️اي ضوجه وماكو تكبيل وكذا تجي نطلع☹️",
...
async def on_message(message):
    ...
    try:
        ...
        if content and uid_str:
            ...
            if any(word in words_in_msg for word in BAD_WORDS):
